...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.ForeignKey(
                "stores.id",
                ondelete="RESTRICT",
                name="fk_purchase_orders_store_id",
            ),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), primary_key=True),
        sa.Column("purchase_order_id", sa.Integer(), sa.ForeignKey(
            "purchase_orders.id", ondelete="CASCADE"), nullable=False),
        ...
        sa.Column("unit_cost", sa.Numeric(12, 2),
                  nullable=False, server_default="0"),
        sa.UniqueConstraint("purchase_order_id", "device_id",
                            name="uq_purchase_item_unique"),
    )
    op.create_index("ix_purchase_order_items_order_id",
                    "purchase_order_items", ["purchase_order_id"])
    op.create_index("ix_purchase_order_items_device_id",
                    "purchase_order_items", ["device_id"])
    ...
    op.create_table(
        ...
        sa.Column("processed_by_id", sa.Integer(), sa.ForeignKey(
            "users.id", ondelete="SET NULL"), nullable=True),
        sa.Column("created_at", sa.DateTime(timezone=True),
                  nullable=False, server_default=sa.func.now()),
    ...
    op.create_table(
        ...
        sa.Column("created_at", sa.DateTime(timezone=True),
                  nullable=False, server_default=sa.func.now()),
        sa.Column("performed_by_id", sa.Integer(), sa.ForeignKey(
            "users.id", ondelete="SET NULL"), nullable=True),
    ...
    op.create_table(
        "sale_items",
        sa.Column("id", sa.Integer(), primary_key=True),
        sa.Column("sale_id", sa.Integer(), sa.ForeignKey(
            "sales.id", ondelete="CASCADE"), nullable=False),
        sa.Column("device_id", sa.Integer(), sa.ForeignKey(
            "devices.id", ondelete="RESTRICT"), nullable=False),
        sa.Column("quantity", sa.Integer(), nullable=False),
    ...
    if bind.dialect.name != "sqlite":  # SQLite no soporta DROP DEFAULT
        ...
        op.alter_column("purchase_order_items",
                        "quantity_received", server_default=None)
        op.alter_column("purchase_order_items",
                        "unit_cost", server_default=None)
...
def downgrade() -> None:
    ...
    op.drop_index("ix_purchase_returns_device_id",
                  table_name="purchase_returns")
    op.drop_index("ix_purchase_returns_order_id",
                  table_name="purchase_returns")
    op.drop_table("purchase_returns")

    op.drop_index("ix_purchase_order_items_device_id",
                  table_name="purchase_order_items")
    op.drop_index("ix_purchase_order_items_order_id",
                  table_name="purchase_order_items")
