...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["supplier_id"],
            ["suppliers.id"],
            name="fk_supplier_batches_supplier_id",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["store_id"],
            ["stores.id"],
            name="fk_supplier_batches_store_id",
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["device_id"],
            ["devices.id"],
            name="fk_supplier_batches_device_id",
            ondelete="SET NULL",
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("supplier_id", "batch_code",
                            name="uq_supplier_batch_code"),
    )
    op.create_index(op.f("ix_supplier_batches_id"),
                    "supplier_batches", ["id"], unique=False)
    op.create_index(
...
def downgrade() -> None:
    op.drop_index(op.f("ix_supplier_batches_device_id"),
                  table_name="supplier_batches")
    op.drop_index(op.f("ix_supplier_batches_store_id"),
                  table_name="supplier_batches")
    op.drop_index(op.f("ix_supplier_batches_supplier_id"),
                  table_name="supplier_batches")
    op.drop_index(op.f("ix_supplier_batches_id"),
                  table_name="supplier_batches")
