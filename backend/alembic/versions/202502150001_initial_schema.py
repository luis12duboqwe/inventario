...
movement_type_enum = sa.Enum("entrada", "salida", "ajuste", name="movement_type")
...
def upgrade() -> None:
    ...
    op.create_unique_constraint("uq_devices_store_sku", "devices", ["store_id", "sku"])
    ...
    op.create_index("ix_sync_sessions_id", "sync_sessions", ["id"], unique=False)
    op.create_index("ix_sync_sessions_store_id", "sync_sessions", ["store_id"], unique=False)
    op.create_index("ix_sync_sessions_triggered_by_id", "sync_sessions", ["triggered_by_id"], unique=False)
    ...
    op.create_index("ix_audit_logs_performed_by_id", "audit_logs", ["performed_by_id"], unique=False)
    ...
    op.create_index("ix_backup_jobs_triggered_by_id", "backup_jobs", ["triggered_by_id"], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index("ix_sync_sessions_triggered_by_id", table_name="sync_sessions")
