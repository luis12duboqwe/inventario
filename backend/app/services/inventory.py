...
from .. import schemas
from ..usecases import inventory as inventory_usecases
...
def list_stores(
    ...
    *,
    ...
    stores = inventory_usecases.list_stores(db, limit=limit, offset=offset)
...
def create_store(db: Session, store_in: schemas.StoreCreate) -> schemas.StoreResponse:
    ...
    store = inventory_usecases.create_store(
        db,
        store_in,
...
def list_devices(
    ...
    *,
    ...
    devices = inventory_usecases.list_devices(
        db,
        store_id,
        limit=limit,
        offset=offset,
...
def create_device(
    ...
    *,
    ...
    device = inventory_usecases.create_device(
        db,
        store_id=store_id,
        device_in=device_in,
        performed_by_id=None,
