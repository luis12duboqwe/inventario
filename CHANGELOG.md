...
- **Caché temporal para el SDK web**: la función `request` de `frontend/src/api.ts` incorpora memoización con TTL de 60 segundos para peticiones GET, limpieza automática tras operaciones mutables y el helper `clearRequestCache` para escenarios de pruebas.【F:frontend/src/api.ts†L1586-L1710】
