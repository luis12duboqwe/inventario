...
5. ✅ **Monitoreo Prometheus**: `/monitoring/metrics` (rol ADMIN) expone contadores de acuses, fallos y cache TTL instrumentados en `backend/app/telemetry.py`; valida su salida cuando ejecutes pruebas de Seguridad.
