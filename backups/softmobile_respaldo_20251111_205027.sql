...
INSERT INTO "usuarios" ("id_usuario", "correo", "nombre", "telefono", "rol", "estado", "password_hash", "supervisor_pin_hash", "is_active", "fecha_creacion", "failed_login_attempts", "last_login_attempt_at", "locked_until", "sucursal_id") VALUES (1, 'xreason_admin_f23a6cd5', 'Admin XReason', NULL, 'ADMIN', 'ACTIVO', '$pbkdf2-sha256$29000$wphzbu19712LcW7N.X9PqQ$MpBy1yKqM4nWp/wA8VOHKAoyKCA.8Rjc1W7BR0UPHyk', NULL, 1, '2025-11-11T20:50:27.588931', 0, '2025-11-11T20:50:27.615739', NULL, NULL);
DELETE FROM "wms_bins";
DELETE FROM "active_sessions";
INSERT INTO "active_sessions" ("id", "user_id", "session_token", "created_at", "last_used_at", "expires_at", "revoked_at", "revoked_by_id", "revoke_reason") VALUES (1, 1, '66085bcf84ff416888a3b2b232492c63', '2025-11-11T20:50:27.614764', '2025-11-11T20:50:27.755452', '2025-11-11T21:50:27.613949', NULL, NULL, NULL);
DELETE FROM "audit_alert_acknowledgements";
DELETE FROM "audit_logs";
INSERT INTO "audit_logs" ("id", "action", "entity_type", "entity_id", "details", "performed_by_id", "created_at") VALUES (1, 'user_created', 'user', '1', '{"description": "Usuario creado: xreason_admin_f23a6cd5", "metadata": {"roles": ["ADMIN"]}}', NULL, '2025-11-11T20:50:27.595715');
INSERT INTO "audit_logs" ("id", "action", "entity_type", "entity_id", "details", "performed_by_id", "created_at") VALUES (2, 'auth_login_success', 'user', '1', '{"session_hint": "492c63"}', 1, '2025-11-11T20:50:27.616942');
...
INSERT INTO "logs_sistema" ("id_log", "usuario", "modulo", "accion", "descripcion", "fecha", "nivel", "ip_origen", "audit_log_id") VALUES (1, NULL, 'usuarios', 'user_created', 'Usuario creado: xreason_admin_f23a6cd5', '2025-11-11T20:50:27.595925', 'INFO', NULL, 1);
INSERT INTO "logs_sistema" ("id_log", "usuario", "modulo", "accion", "descripcion", "fecha", "nivel", "ip_origen", "audit_log_id") VALUES (2, 'xreason_admin_f23a6cd5', 'usuarios', 'auth_login_success', 'session_hint: 492c63', '2025-11-11T20:50:27.617081', 'INFO', NULL, 2);
