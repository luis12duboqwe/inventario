...
- **Caché inteligente para peticiones de API**: el helper `request` memoiza respuestas GET durante 60 segundos, invalida la caché tras operaciones mutables y ofrece utilidades de reseteo utilizadas en nuevas pruebas de Vitest.【F:frontend/src/api.ts†L1586-L1710】【F:frontend/src/api.cache.test.ts†L1-L109】
