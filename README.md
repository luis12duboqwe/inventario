...
- **Validación corporativa del motivo**: `MovementCreate` normaliza el comentario, rechaza cadenas de menos de 5 caracteres y asegura que el motivo registrado coincida con la cabecera `X-Reason` en todas las operaciones.
