...
function DeviceEditDialog({ device, open, onClose, onSubmit }: Props) {
  ...
  useEffect(() => {
    ...
    setForm({
      ...
      color: device.color ?? "",
      estado: device.estado_comercial ?? "",
      unitPrice: device.unit_price != null ? String(device.unit_price) : "",
      costoUnitario: device.costo_unitario != null ? String(device.costo_unitario) : "",
      margen: device.margen_porcentaje != null ? String(device.margen_porcentaje) : "",
      garantia: device.garantia_meses != null ? String(device.garantia_meses) : "",
      lote: device.lote ?? "",
      fechaCompra: device.fecha_compra ?? "",
      capacidad: device.capacidad_gb != null ? String(device.capacidad_gb) : "",
