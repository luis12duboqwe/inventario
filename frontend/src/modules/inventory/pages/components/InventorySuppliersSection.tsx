...
import "./InventorySuppliersSection.css";
      ...
      <header className="card-header">
        <div>
          ...
          <p className="card-subtitle">
            Seguimiento de compras asociadas a{" "}
            {selectedStore ? selectedStore.name : "cada sucursal"}.
          </p>
        </div>
          ...
          {supplierBatchOverview.map((item) => (
            <li key={item.supplier_id}>
              ...
              <div className="muted-text">
                ...
                {new Date(item.latest_purchase_date).toLocaleDateString("es-HN")}
